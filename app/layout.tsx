        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
          <div className="max-w-2xl mx-auto px-4 h-14 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2">
              <span className="text-[#1D9E75] font-medium text-lg tracking-tight">Mile Marker</span>
            </Link>
            <nav className="flex items-center gap-1">
              <Link href="/" className="flex flex-col items-center gap-0.5 px-3 py-1 rounded-lg text-gray-500 hover:text-[#1D9E75] hover:bg-gray-50 transition-colors">
                <HomeIcon />
                <span className="text-[10px] font-medium hidden sm:block">Home</span>
              </Link>
              <Link href="/leaderboards" className="flex flex-col items-center gap-0.5 px-3 py-1 rounded-lg text-gray-500 hover:text-[#1D9E75] hover:bg-gray-50 transition-colors">
                <TrophyIcon />
                <span className="text-[10px] font-medium hidden sm:block">Leaderboards</span>
              </Link>
              <Link href="/club" className="flex flex-col items-center gap-0.5 px-3 py-1 rounded-lg text-gray-500 hover:text-[#1D9E75] hover:bg-gray-50 transition-colors">
                <UsersIcon />
                <span className="text-[10px] font-medium hidden sm:block">Club</span>
              </Link>
